    ...
    ui(new Ui::SettingsFaqWidget)
{
        ...
        formatFAQParagraph(
            tr("You can see the status of staking in the wallet by mousing over the "
               ...
               "will confirm that staking is active.")
                .arg("1776cash-cli", "<span style=\"font-style:italic\">getstakingstatus</span>")));
    ...
    connect(ui->pushButtonWebLink, &QPushButton::clicked, [](){ QDesktopServices::openUrl(QUrl("https://1776CASH.com")); });
