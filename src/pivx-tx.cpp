...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " 1776cash-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  1776cash-tx [options] <hex-tx> [commands]  Update hex-encoded 1776CASH transaction\n" +
                               "or:     1776cash-tx [options] -create [commands]   Create hex-encoded 1776CASH transaction\n" +
                               "\n";
