...
const char * const PIVX_CONF_FILENAME = "1776CASH.conf";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";


// 1776CASH only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\1776CASH
// Windows >= Vista: C:\Users\Username\AppData\Roaming\1776CASH
// Mac: ~/Library/Application Support/1776CASH
// Unix: ~/.pivx
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "1776CASH";
#else
    fs::path pathRet;
...
static fs::path ZC_GetBaseParamsDir()
{
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "1776CASHParams";
#else
    fs::path pathRet;
    char* pszHome = getenv("HOME");
    if (pszHome == nullptr || strlen(pszHome) == 0)
    ...
    pathRet /= "Library/Application Support";
    TryCreateDirectories(pathRet);
    return pathRet / "1776CASHParams";
#else
    // Unix
    return pathRet / ".1776CASH-params";
#endif
#endif
}
